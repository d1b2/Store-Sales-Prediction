from store.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig,   \
...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            #raw_train_data_dir = data_ingestion_info[DATA_INGESTION_RAW_TRAIN_DIR_KEY]
            #raw_train_data_dir=data_ingestion_info[DATA_INGESTION_RAW_TRAIN_DIR_KEY]
            
            raw_train_data_dir = os.path.join(data_ingestion_artifact_dir,
            data_ingestion_info[DATA_INGESTION_RAW_TRAIN_DIR_KEY]
            )

            raw_test_data_dir = os.path.join(data_ingestion_artifact_dir,
            data_ingestion_info[DATA_INGESTION_RAW_TEST_DIR_KEY]
            )
            ...
            data_ingestion_config=DataIngestionConfig( 
                raw_train_data_dir=raw_train_data_dir, 
